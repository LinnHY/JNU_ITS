    ...
    methods: {
        ...
        getSelectArea() {
            ...
            this.componentData.forEach((component) => {
                if (component.isLock) return; // 若是已锁定的组件 则无法被圈中
        ...
        getTextareaHeight(element, text) {
            ...
            const newHeight =
                (text.split("<br>").length - 1) * lineHeight * (fontSize || this.canvasStyleData.fontSize);
